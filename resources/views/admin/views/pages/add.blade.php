...
<div class="form-group">
	...
	<div class="input-group">
		<input type="text" class="form-control" id="name" name="page[name]" placeholder="{{ __('Название страницы') }}" />
	</div>		
</div> 
<div class="form-group">
	<label for="url">{{ __('URL страницы') }}</label>
	<div class="input-group">
		<input type="text" class="form-control" id="url" name="page[url]" placeholder="{{ __('URL страницы') }}" />
	</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('#url').keyup(function(){isUrlPage(0);}).change(function(){isUrlPage(0);}).click(function(){isUrlPage(0);});
...
<div class="form-group">
	...
	<div class="input-group">
		<input type="text" class="form-control" id="title" name="page[title]" placeholder="{{ __('Title страницы') }}" />
	</div>		
</div> 
<div class="form-group">
	<label for="description">{{ __('Description страницы') }}</label>
	<div class="input-group">
		<input type="text" class="form-control" id="description" name="page[description]" placeholder="{{ __('Description страницы') }}" />
	</div>		
</div> 
<div class="form-group">
	<label for="keywords">{{ __('Keywords страницы') }}</label>
	<div class="input-group">
		<input type="text" class="form-control" id="keywords" name="page[keywords]" placeholder="{{ __('Keywords страницы') }}" />
	</div>		
</div> 
<div class="form-group">
	<label for="image">{{ __('og:Image страницы') }}</label>
	<div class="input-group">
		{!! EntitiesFields::TypesList()["image"]["html"](__('og:Image страницы'),"image","page[image]",null,null) !!}	
	</div>		
</div> 
<div class="form-group">
